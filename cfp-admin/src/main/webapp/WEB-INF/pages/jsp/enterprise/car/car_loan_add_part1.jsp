...
<html>
<body>
<div id="car_loan_add_part1" class="container-fluid" style="padding: 50px 0px 0px 10px;width:50%;">
<input style="float: right;width: 100px" type="button" class="btn  btn-primary"  value="保 存" onclick="save_car_loan_add_part1();">
<form class="form-horizontal" id="car_loan_add_part1_form" method="post">
...
//借款用途下拉框。
$("#car_loan_add_part1_form #loanUseage").combobox({
...
//内部评级下拉框。
$("#car_loan_add_part1_form #internalRating").combobox({
...
//借款产品下拉框。
$("#car_loan_add_part1_form #loanProductId").combobox({
...
//打款卡下拉框。
$("#car_loan_add_part1_form #inCardId").combobox({
...
// 执行:保存。
function save_car_loan_add_part1(){
	
	// 验证
	if(!$("#car_loan_add_part1_form").form('validate')){
		return false;
	}
	...
	$.post('${ctx}/jsp/enterprise/loan/save_enterprise_loan_car?r=' + Math.random(),
   		$("#car_loan_add_part1_form").serialize(),
   		function(data){
   	    	if(data.result == 'success'){
