...
<html>
<body>
<div id="car_loan_add_part2" class="container-fluid" style="padding: 50px 0px 0px 10px;width:50%;">
<input style="float: right;width: 100px;" type="button" class="btn  btn-primary"  value="保 存" onclick="save_car_loan_add_part2();">
<form class="form-horizontal" id="car_loan_add_part2_form" method="post" style="margin-top: 50px;">
          ...
          <td>
				...
				<div class="control-group" id="carInfo">
                    <label class="control-label">
                    	<input type="radio" id="arrived" name="arrived" value="1" checked="checked"><span style="font-size: 12px;">一抵</span>&nbsp;&nbsp;&nbsp;&nbsp;
                    	<input type="radio" id="arrived" name="arrived" value="2"><span style="font-size: 12px;">二抵</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					汽车品牌：</label>
                    <div class="controls" >
                        ...
                        name="marketPrice" id="marketPrice" onkeyup="onRatio();"><span style="font-size: 12px;">万元</span>&nbsp;&nbsp;
                ...
                <hr id="carInfo_end">
          		...
          		<div class="control-group">
                    ...
                    <div class="controls">
                       	<span style="font-size: 12px;" id="totalMortgageValue">0</span><span style="font-size: 12px;">万元</span>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" style="width: 100px;margin-top: 3px;"
                        	...
                        	name="creditLimit" id="creditLimit" onkeyup="onRatio();"><span style="font-size: 12px;">万元</span>
                        	&nbsp;&nbsp;&nbsp;&nbsp;
...
// 执行:保存。
function save_car_loan_add_part2(){
	
	// 验证
	if(!$("#car_loan_add_part2_form").form('validate')){
		return false;
	}
	...
	$.post('${ctx}/jsp/enterprise/loan/save_enterprise_loan_mortgage_car?r=' + Math.random(),
   		$("#car_loan_add_part2_form").serialize(),
   		function(data){
