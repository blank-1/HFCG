...
<html>
<body>
<div id="car_loan_edit_part3" class="container-fluid" style="padding: 50px 0px 0px 10px;width:50%;">
<form class="form-horizontal" id="car_loan_edit_part3_form" method="post">
...
function upButton(state,typeList){
	...
	$("#car_loan_edit_part3_form").after("<div id='upload_snapshot_add' style=' padding:10px; '></div>");
