...
<html>
<body>
<div id="credit_add_part2" class="container-fluid" style="padding: 50px 0px 0px 10px;width:50%;">
<form class="form-horizontal" id="credit_add_part2_form" method="post">
...
function upButton(state,typeList){
	...
	$("#credit_add_part2_form").after("<div id='upload_snapshot_add' style=' padding:10px; '></div>");
