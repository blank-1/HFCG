...
<html>
<body>
<div id="credit_edit_part2" class="container-fluid" style="padding: 50px 0px 0px 10px;width:50%;">
<form class="form-horizontal" id="credit_edit_part2_form" method="post">
      ...
      <tr>
          <td>
				...
				<span style="font-size: 24px;">法人征信报告</span>
          		<input style="margin-left: 820px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('1','legalPersonCreditReport');">
          		<br/><hr>
...
function upButton(state,typeList){
	...
	$("#credit_edit_part2_form").after("<div id='upload_snapshot_add' style=' padding:10px; '></div>");
	$("#upload_snapshot_add").dialog({
        resizable: false,
        title: '上传图片',
        href: '${ctx}/jsp/enterprise/loan/loanUploadSnapshotAdd?state='+ state + '&typeList=' + typeList + '&loanApplicationId=' + loanApplicationId + '&isCode=1&loanType=3',
        width: 400,
        height: 420,
        modal: true,
        top: 100,
