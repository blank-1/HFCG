	...
	<table width="100%" id="showTable">
      <tr>
          <td>
          		...
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('0','legalIdentityCard');">
          		<br/><hr>
				...
				<span style="font-size: 24px;">法人征信报告</span>
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('1','legalPersonCreditReport');">
          		<br/><hr>
          		<div id="legalPersonCreditReport">
          			<c:forEach var="cusvo" items="${attachmentList }">
				...
				<div id="legalPersonCreditReport_name">
          			<c:forEach var="cusvo" items="${attachmentList }">
          				<c:if test="${cusvo.type == 1}">
          					<span id='img_${cusvo.fileName }_span' style='margin: 20px;'>${cusvo.attachment.fileName }</span>
          				</c:if>
				...
				<span style="font-size: 24px;">司法查询</span>
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('2','judicialInquiry');">
          		<br/><hr>
				...
				<span style="font-size: 24px;">合同协议</span>
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('3','contractAgreement');">
          		<br/><hr>
				...
				<span style="font-size: 24px;">项目资料</span>
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('4','projectData');">
          		<br/><hr>
          		<div id="projectData">
          			<c:forEach var="cusvo" items="${attachmentList }">
				...
				<span style="font-size: 24px;">实地尽调</span>
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('5','fieldAdjustment');">
          		<br/><hr>
				...
				<span style="font-size: 24px;">其它</span>
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('6','other');">
          		<br/><hr>
          		<div id="other">
          			<c:forEach var="cusvo" items="${attachmentList }">
