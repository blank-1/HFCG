...
<div style="padding: 10px">
	<div style="float: left;margin-left: 10px;">
		<span style="font-size: 16px;font-weight: bold;">新增企业</span>
	</div>
	<div id="main" style="display: block;" data-options="closable:false,collapsible:false,minimizable:false,maximizable:false">
		...
		<div id="detail" class="container-fluid" style="padding: 5px 0px 0px 10px">
			<div id="tt" class="easyui-tabs" style="width:auto;height:650px" >
				...
				<div title="基本信息" style="padding:10px;" data-options="href:'${ctx}/jsp/enterprise/to_enterprise_add_part1'">1</div>
				<div title="相关附件" style="padding:10px;" data-options="href:'${ctx}/jsp/enterprise/to_enterprise_add_part2'">2</div>
