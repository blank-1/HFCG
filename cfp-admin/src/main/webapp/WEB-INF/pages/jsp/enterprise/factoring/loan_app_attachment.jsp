	...
	<table width="100%" id="showTable">
      <tr>
          <td>
          		...
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('0','relatedContract');">
          		<br/><hr>
				...
				<span style="font-size: 24px;">尽职调查报告</span>
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('1','dueDiligenceReport');">
          		<br/><hr>
				...
				<span style="font-size: 24px;">保理风控要件</span>
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('2','factorOfFactoring');">
          		<br/><hr>
				...
				<span style="font-size: 24px;">其它</span>
          		<input style="margin-left: 600px;" type="button" class="btn btn-primary" value="上传附件" onclick="upButton('3','other');">
          		<br/><hr>
          		<div id="other">
          			<c:forEach var="cusvo" items="${attachmentList }">
