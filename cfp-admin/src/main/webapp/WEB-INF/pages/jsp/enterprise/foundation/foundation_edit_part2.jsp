...
<html>
<body>
<div id="factoring_edit_part2" class="container-fluid" style="padding: 50px 0px 0px 10px;width:50%;">
<form class="form-horizontal" id="factoring_edit_part2_form" method="post">
...
function upButton(state,typeList){
	...
	$("#factoring_edit_part2_form").after("<div id='upload_snapshot_add' style=' padding:10px; '></div>");
	$("#upload_snapshot_add").dialog({
        resizable: false,
        title: '上传图片',
        href: '${ctx}/jsp/enterprise/loan/loanUploadSnapshotAdd?state='+ state + '&typeList=' + typeList + '&loanApplicationId=' + loanApplicationId + '&isCode=1&loanType=5',
        width: 400,
        height: 420,
        modal: true,
        top: 100,
