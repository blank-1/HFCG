...
<div id="loan_contract_List" class="container-fluid" style="padding: 5px 0px 0px 10px">
    <div id="loanContractList_toolbar" style="height:auto">
        ...
        <div id="searchtool" style="padding:5px">
            <form method="post" class="form-inline" id="loan_enterprise_form" action="${ctx}/jsp/enterprise/loan/exportExcel">
                ...
                <span>借款人姓名:</span><input type="text" id="realName" name="realName" style="width: 100px" value="" size=10 onkeydown="if(event.keyCode==13){search();}"/>
...
<script type="text/javascript">
    ...
    function doSearch() {
    	var targetURL = '${ctx}/jsp/enterprise/loan/loan_list';
 ...
 //                      	 }
    ...
    function detail(index) {
        ...
        if (selRow) {
            ...
            $('#loan_detail_d').dialog({
                title : '借款申请详情',
                href: '${ctx}/jsp/enterprise/loan/to_loan_detail?loanApplicationId='+selRow.loanApplicationId,
                width: 1000,
    ...
    function editDetail(index) {
        ...
        var selRow = $("#contract_list").datagrid("getSelected");
        if (selRow) {
        	var url = '${ctx}/jsp/enterprise/loan/to_part?actionType=edit&loanApplicationId=' + selRow.loanApplicationId + '&loanType=' + selRow.loanType;
    ...
    function delete_loan_application(index) {
        ...
        if (selRow) {
			$.messager.confirm('删除借款合同提示','您是否要删除'+(selRow.loanApplicationName==null ? '' : selRow.loanApplicationName )+'借款合同?',function(r){
				if(r){
					$.post('${path}/jsp/loan_application/controller/delete',
							{'loanApplicationId':selRow.loanApplicationId},
							function(data){
    ...
    function agreement(index) {
        ...
        $.post('${ctx}/jsp/financial/createAgreement',
        		{loanApplicationId:selRow.loanApplicationId},
        		function(data) {
            if (data == 'success') {
