...
<form class="form-horizontal" id="repayment_form" method="post">
    ...
    <input type="hidden" id="isAheadStr" name="isAheadStr" value="${isAhead}">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" required="true" readonly class="easyui-numberbox" data-options="min:0,precision:2"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <div class="btn-group" data-toggle="buttons-radio">
                <input type="button" class="btn active" id="notUseBalance" onclick="$('#isUserBalance').val(0)"
                       value="不使用">
...
<script language="JavaScript">
    ...
    if ('${balanceInfo}') {
        ...
        var aheadFee = '${balanceInfo.aheadFee}';
        if (!aheadFee) {
            aheadFee = 0;
        }
        ...
        $("#repaymentInfo").html("本金:" + formatNum(capital, 2) + "元,利息:" + formatNum(interest, 2) + "元,费用:" + formatNum(feesBalance, 2) + "元,罚息:" + formatNum(defaultInterest, 2) + "元,提前还款手续费:"+ formatNum(aheadFee, 2));
