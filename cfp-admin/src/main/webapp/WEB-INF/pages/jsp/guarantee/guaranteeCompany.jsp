        ...
        <form class="form-horizontal" id="withDraw_form" method="post" action="${ctx}/bondSource/withDraw">
            ...
            <c:if test="${not empty customerCard.cardCodeShort }">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                           <input type="radio" name="isCardUsed" value="0" onclick="showCardInput(0)"/>
...
<div id="cardInput" <c:if test="${not empty customerCard.cardCodeShort }"> style="display: none;"</c:if>>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea name="remark" autocomplete="off" class="textbox-text validatebox-text" placeholder="" style="margin-left: 0px; margin-right: 0px; height: 75px; width: 250px;"></textarea>
                </div>
            </div>
</div>
        </form>
