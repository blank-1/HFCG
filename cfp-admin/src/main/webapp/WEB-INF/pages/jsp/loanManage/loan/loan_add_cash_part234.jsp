		...
		<div id="detail" class="container-fluid" style="padding: 5px 0px 0px 10px">
			<div id="tt" class="easyui-tabs" style="width:auto;height:650px" >
				...
				<c:if test="${actionType == 'add'}">
					...
					<div title="相关附件" style="padding:10px" data-options="href:'${ctx}/jsp/loanManage/loan/to_loan_add_part4?isCcreditCar=2&loanApplicationId=${loanApplicationId}'">3</div>
				</c:if>
