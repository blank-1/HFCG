			...
			<div id="tt" class="easyui-tabs" style="width:auto;height:650px" >
				...
				<c:if test="${actionType == 'add'}">
	                ...
	                <c:if test="${loanType != '0'}" >
	                    <div title="抵押信息" style="padding:10px" data-options="href:'${ctx}/jsp/loanManage/loan/to_loan_add_part3?loanApplicationId=${loanApplicationId}'">2</div>
	                </c:if>
					<div title="相关附件" style="padding:10px" data-options="href:'${ctx}/jsp/loanManage/loan/to_loan_add_part4?loanApplicationId=${loanApplicationId}'">3</div>
				</c:if>
				
				<c:if test="${actionType == 'edit'}">
					<div title="详细信息" style="padding:10px" data-options="href:'${ctx}/jsp/loanManage/loan/to_loan_edit_part2?loanApplicationId=${loanApplicationId}'">1</div>
	                <c:if test="${loanType != '0'}" >
	                ...
	                <c:if test="${applicationState == 0 }">
						<div title="相关附件" style="padding:10px" data-options="href:'${ctx}/jsp/loanManage/loan/toSnapshotEdit?isCode=1&loanApplicationId=${loanApplicationId}'">3</div>
					</c:if>
				</c:if>
