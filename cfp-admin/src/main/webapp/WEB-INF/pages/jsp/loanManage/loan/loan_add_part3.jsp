      ...
      <tr>
          <td>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <input type="radio" id="mortgageType" name="mortgageType" value="1" checked="checked"><font style="font-size: 12px;">一抵</font>
                        <input type="radio" id="mortgageType" name="mortgageType" value="2" ><font style="font-size: 12px;">二抵</font>
                    </div>
                </div>
				...
				<div class="control-group">
                    ...
                    <div class="controls" >
                        <input name="houseAddr_provence" id="houseAddr_provence" style="width: 130px" >
                        <span style="font-size: 12px;">省</span>
                        <input name="houseAddr_city" id="houseAddr_city" style="width: 130px" >
                        <span style="font-size: 12px;">市</span>
                        <input name="houseAddr_district" id="houseAddr_district" style="width: 130px">
                        ...
                        name="houseAddr_detail" id="houseAddr_detail">
                    </div>
                </div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" style="width: 200px;margin-top: 3px;"
                        	...
                        	name="houseSize" id="houseSize"><span style="font-size: 12px;">平米</span>
                    </div>
                </div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" style="width: 200px;"
                        	class="easyui-numberbox" validType="length[0,4]" precision="0"
                        	name="buyValue" id="buyValue"><span style="font-size: 12px;">万元</span>
                    </div>
                </div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" style="width: 200px;"
                        	class="easyui-numberbox" validType="length[0,4]" precision="0"
                        	name="marketValue" id="marketValue"><span style="font-size: 12px;">万元</span>
                    </div>
                </div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" style="width: 200px;"
                        	class="easyui-numberbox" validType="length[0,4]" precision="0"
                        	name="assessValue" id="assessValue"><span style="font-size: 12px;">万元</span>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" style="width: 200px;"
                        	...
                        	name="houseCardNumber" id="houseCardNumber">
                    </div>
                </div>
