                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" style="width: 200px"
                                   ...
                                   name="loanBalance" id="loanBalance"  value="${loan.loanBalance}"><a style="font-size: 12px;cursor: pointer;"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" style="width: 200px;margin-top: 3px;"
                                   ...
                                   name="carModel" id="carModel"   value="${customerCarSnapshot.carModel}"><span style="font-size: 12px;"></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" style="width: 200px;margin-top: 3px;"
                                   ...
                                   name="mileage" id="mileage" value="${customerCarSnapshot.mileage}"><span style="font-size: 12px;">公里</span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" style="width: 200px;"
                                   ...
                                   name="buyTime" id="buyTime"  value="${carBurTime}"
    >
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" style="width: 200px;"
                                   ...
                                   name="carMoney" id="carMoney"  value="${customerCarSnapshot.carMoney}"><span style="font-size: 12px;">万元</span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" style="width: 200px;"
                                   class="easyui-numberbox" validType="length[0,5]" precision="0"
                                   name="appraisal" id="appraisal" value="${customerCarSnapshot.appraisal}"><span style="font-size: 12px;">万元</span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" style="width: 200px;"
                                   ...
                                   name="originalPrice" id="originalPrice" value="${customerCarSnapshot.originalPrice}"><span style="font-size: 12px;">万元</span>
