	...
	<div id="orderList_toolbar" style="height:auto">
        <div class="container-fluid" style="padding: 5px 0px 0px 10px">
            <form action="${ctx}/jsp/lendList/order_list" method="post" class="form-inline">
            	<span>名称:</span><input type="text" id="searchBannerName" size=6/>&nbsp;&nbsp;&nbsp;&nbsp;
            	<span>状态:</span>
				<select id="searchBannerNameState" class="easyui-combobox" style="width: 130px;" >
...
<script language="javascript">
 /**
    ...
    function doSearch(){
        var searchInfo = {};
        searchInfo.bannerName=$("#searchBannerName").val();
        if('' != $('#searchBannerNameState').combobox('getValue')){
        	searchInfo.state=$('#searchBannerNameState').combobox('getValue');
        }
        searchInfo.startDate=$("#searchBeginTime").datebox("getValue");
        searchInfo.endDate=$("#searchEndTime").datebox("getValue");
        $('#AppBannerList_list').datagrid('load',searchInfo);
    }
    ...
    function loadList(){
        $("#AppBannerList_list").datagrid({
            idField: 'appBannerId',
            title: '微信 Banner页列表',
            url: '${ctx}/jsp/app/app_banner_list?appType=4',
            pagination: true,
            pageSize: 10,
    ...
    function addAppBanner(index) {
        ...
        $("#addAppBanner").dialog({
            resizable: false,
            title: '微信 Banner添加',
            href: '${ctx}/jsp/app/to_app_banner_add?type=1',
            width: 550,
            height: 400,
            modal: true,
            top: 100,
    ...
    function editStartPage(index) {
        ...
        if (selRow) {
            ...
            $("#editAppBanner").dialog({
                resizable: false,
                title: '微信 Banner编辑',
                href: '${ctx}/jsp/app/to_wechat_banner_edit?appBannerId=' + selRow.appBannerId+"&type=1",
                width: 550,
                height: 400,
                modal: true,
                top: 100,
    ...
    function showStartPage(index) {
    	...
    	if (selRow) {
            ...
            $("#showAppBanner").dialog({
                resizable: false,
                title: '微信 Banner页信息',
                href: '${ctx}/jsp/app/to_app_banner_show?appBannerId=' + selRow.appBannerId+"&type=1",
                width: 700,
                height: 400,
                modal: true,
                top: 100,
