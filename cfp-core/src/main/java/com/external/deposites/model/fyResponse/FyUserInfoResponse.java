 ...
 * @author zuowansheng
 */
public class FyUserInfoResponse extends AbstractResponse {
	private Set<FyUserInfoResponseItem> results = new HashSet<>();

	public Set<FyUserInfoResponseItem> getResults() {
		return results;
	}

	public void setResults(Set<FyUserInfoResponseItem> results) {
