...
public class TransactionQueryResponseIteam implements Serializable{
	
	private static final long serialVersionUID = 1440336493245055451L;
    ...
    public boolean isSuccess() {
        return "0000".equals(this.getTxn_rsp_cd());
    }
