 ...
 */
public class QueryRechargeWithdrawResponse extends AbstractResponse {
    @ApiParameter
    private String busi_tp; // 业务类型
    @ApiParameter
    private String total_number; //总记录数

    private Set<QueryRechargeResponseItem> results = new HashSet<>();
    ...
    public Set<QueryRechargeResponseItem> getResults() {
        return results;
    }

    public void setResults(Set<QueryRechargeResponseItem> results) {
