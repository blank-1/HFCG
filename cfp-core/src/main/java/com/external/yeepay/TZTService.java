...
public class TZTService {
	...
	public static String getCallbackUrl() {
		return Configuration.getInstance().getValue("callbackUrl");
	}
	...
	public static boolean isBindCard() {
		return Configuration.getInstance().getValue("testBindCard").equals("1");
	}
	 ...
	 * @throws Exception
	 */
	public static Map<String, String> parseCallbackRequest(Map<String, String> params) throws Exception {
		...
		String dataFromYeepay		= formatString(params.get("data"));
		String encryptkeyFromYeepay	= formatString(params.get("encryptkey"));
