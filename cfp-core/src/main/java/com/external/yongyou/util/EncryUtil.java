...
import com.xt.cfp.core.Exception.code.ext.SecurityErrorCode;
...
public class EncryUtil {
	 ...
	 * @throws Exception
	 */
	public static TreeMap<String,String> getDataMapDecryptAndSign(String data, String encrypt_key,
											  String yibaoPublickKey, String merchantPrivateKey) throws Exception {
		...
		if(result){
			...
			throw new SystemException(SecurityErrorCode.DECRYPT_FAIL_RSA);
		}
	}
