...
//    WITHDRAW("WithDraw","提现单"),
    ...
    public enum AccountTypeEnum implements EnumsCanDescribed {
        ...
        private static final Map<String, AccountTypeEnum> cached = new HashMap<>(7);

        static {
            for (AccountTypeEnum accountTypeEnum : AccountTypeEnum.values()) {
                cached.put(accountTypeEnum.value, accountTypeEnum);
            }
        }

        static AccountTypeEnum byValue(Integer value) {
    ...
    public enum BusinessTypeEnum implements EnumsCanDescribed {
        ...
        FEESTYPE_BUYFINANCEFREEZEN("36", "购买省心计划冻结"),
        FEESTYPE_BUYFINANCEUNFREEZEN("37", "购买省心计划失败解冻"),
        FEESTYPE_BUYFINANCE_TRANSFER("38", "购买省心计划"),
        ...
        FEESTYPE_BUYRIGHTSFREEZEN("54", "购买债权冻结"),
        FEESTYPE_BUYRIGHTSUNFREEZEN("55", "购买债权失败解冻"),
        FEESTYPE_TURNRIGHTS("56", "债权转让"),
        FEESTYPE_TURNRIGHTS_FEE("57", "债权转让费"),
        FEESTYPE_TURNRIGHTS_UNDO("58", "债权转让撤销解冻"),
        FEESTYPE_FINANCE_BID_UNDO("59", "省心计划购买标的撤销解冻"),
        FEESTYPE_PAY_COMMISION("60", "平台支出佣金"),
        FEESTYPE_INCOME_COMMISION("61", "出借人收入佣金奖励"),
        FEESTYPE_PAY_RATE_COUPON("62", "平台支出加息券奖励"),
        FEESTYPE_INCOME_RATE_COUPON("63", "出借人收入加息券奖励"),
        FEESTYPE_PAY_ACTIVITY_AWARD("64", "平台支出活动奖励"),
        FEESTYPE_INCOME_ACTIVITY_AWARD("65", "出借人收入活动奖励"),
        FEESTYPE_PLATFORM_INCOME_ACTIVITY_AWARD("66", "平台收回活动奖励"),
        FEESTYPE_ERROR_PAY_AWARD("67", "取消错误的活动奖励"),
        FEESTYPE_BALANCE_CHANGE_FREEZE("68", "资金冻结"),
        FEESTYPE_MAKELOAN("70", "放款"),
        FEESTYPE_BALANCE_CHANGE_THAW("69", "资金解冻");;
