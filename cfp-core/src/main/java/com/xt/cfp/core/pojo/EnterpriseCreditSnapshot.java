 ...
 * 企业信贷
 */
public class EnterpriseCreditSnapshot{
    private Long enterpriseCreditId;//信贷ID
 ...
 // 辅助字段
    ...
    public Long getEnterpriseCreditId() {
        return enterpriseCreditId;
    }

    public void setEnterpriseCreditId(Long enterpriseCreditId) {
