...
public class RightsRepaymentDetailExt {
	...
	// 已获收益
	private String supportProfit;
	
	
	public String getSupportProfit() {
		return supportProfit;
	}
	public void setSupportProfit(String supportProfit) {
	...
	public void setAllBackMoney(String allBackMoney) {
	...
	public void setRightsDetailState(String rightsDetailState) {
