...
//        hint.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);
        ...
        if (!ImageIO.write(bufferedImage, "jpg", new File("d:\\temp.jpg"))) {
...
//                            : 0xfffffff;
                    pixels[y * width + x] = matrix.get(x, y) ? 0x0000000
                            : 0xfffffff;
                }
            }
        }
    ...
    private static BufferedImage scale(String srcImageFile, int height,
        ...
        ImageInputStream imageInputStream = ImageIO.createImageInputStream(destImage);

//        FileImageOutputStream fileImageOutputStream = new FileImageOutputStream(new File("e:\\a.jpg"));
