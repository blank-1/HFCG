...
public class ShareCodeUtil {
	...
	private static final char[] r = new char[] { 'q', 'w', 'e', '8', 'a', 's', '2', 'd', 'z', 'x', '9', 'c', '7', 'p', '5', 'i', 'k', '3', 'm', 'j',
	...
	public static void main(String[] args) {
		System.out.println(toSerialCode(99999999));
		System.out.println(codeToId("em9f7q"));
	}
}
