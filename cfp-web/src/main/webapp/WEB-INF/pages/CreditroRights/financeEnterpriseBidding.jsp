	...
	<div class="loanlist">
		<div class="loanlist-con">
			<div class="loanlist-top">
				...
				<c:if test="${loanApplicationListVO.loanType ne '5'}">
			...
			<div class="loanlist-bot">
				<div class="loanlist-bot-le">
					<div class="loanlist-bot-le-tp money">
						...
						<div class="loanlist-bot-div2 zr-loanlist-pd">
							剩余期限<br />
							<big class="bigyear" data-term="${surpMonth}">${surpMonth}</big>个月
						</div>
						<div class="loanlist-bot-div zr-loanlist-pd">
							剩余本金（元）<br />
							<big class="bigyear" id="confirmBalance"><fmt:formatNumber value="${shouldCapital}" pattern="#,##0.00" /> </big>
							<div class="lb-jdt">
						...
						<div class="loanlist-bot-div1 zr-loanlist-pd lb-br-none">转出价格（元）<br />
				...
				<div class="loanlist-bot-ri">
					...
					<div class="clear_30"></div>
						...
						<input id="limit_input" type="hidden" value="${loanApplicationListVO.confirmBalance}" />
						<p>账户余额：
...
<div class="list_tab">
    <h6>
        <c:if test="${loanApplicationListVO.loanType eq '2'}">
            ...
            <span class="border-right-none">抵押信息</span>
	    ...
	    <c:if test="${loanApplicationListVO.loanType eq '4'}">
            ...
            <span class="border-right-none">项目保障方案</span>
            <span class="border-right-none">保理公司</span>
            <span class="border-right-none">投标信息</span>
            <span class="border-right-none">还款列表</span>
	    </c:if>
	    <c:if test="${loanApplicationListVO.loanType eq '5'}">
...
<script type="text/javascript" src="${ctx}/js/rightsBidding.js"></script>
                ...
                <div class="thumbCont">
                    <ul>
                        ...
                        <c:forEach items="${customerUploadSnapshots}" var="customersnapshot">
                            <li>
                                <div><img src="${customersnapshot.attachment.thumbnailUrl}" url="url"
