...
.detail-dxb{position:absolute;z-index:9;top:59px;left:20px;width:357px;height:115px;background:#F7F7F7;border:1px #ddd solid;text-align:center;padding:20px 40px 65px;}
