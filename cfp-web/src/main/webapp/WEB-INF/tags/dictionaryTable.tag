<%@tag pageEncoding="utf-8"%><%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %><%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %><%@ tag import="com.xt.cfp.core.service.ConstantDefineService"%><%@ tag import="com.xt.cfp.core.pojo.ConstantDefine" %><%@ tag import="java.util.List" %><%@ tag import="com.xt.cfp.core.util.ApplicationContextUtil" %><%@ tag import="org.apache.commons.lang.StringUtils" %><%@attribute name="constantTypeCode"  required="true" %><%@attribute name="key"  required="false" rtexprvalue="true" %><%@attribute name="id" required="false" %><%@attribute name="name" required="false" %><%@attribute name="style" required="false" %><%@attribute name="isWholeUse" required="false" type="java.lang.Boolean"  %><%@attribute name="wholeValue" required="false" %><%@attribute name="desc" required="true" type="java.lang.Boolean" %><%@attribute name="keyType" required="false" %><%
