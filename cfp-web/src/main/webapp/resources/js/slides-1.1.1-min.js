        ...
        return this.each(function() {
            ...
            if (b.thumb) {
                ...
                C.children(":eq(0)").children().each(function(L) {
                    ...
                    var K = '<li><div class="imgWrap"><a href="javascript:void(0);" title="' + I + '"><img src="' + N + '" alt="' + I + '" /></a></div><div class="opacity"></div><div class="textDesc"><div class="title"><a href="' + J + '" target="_blank">' + I + '</a></div><div class="text">' + M + "</div></div></li>";
                    a(this).data("data", L);
                    q.append(K)
                });
