...
<script data-main="${ctx }/js/s_listCredits.js?${version}" src="${ctx }/js/lib/require.js"></script>
...
<body class="l_NewScroll">
	<div class="s_content">
		<ul class="headNav">
			<li class="listCur"><a href="javascript:;">回款中</a></li>
			<li><a href="javascript:;">已结清</a></li>
		</ul>
		<div class="mainList">
			<div class="page">
