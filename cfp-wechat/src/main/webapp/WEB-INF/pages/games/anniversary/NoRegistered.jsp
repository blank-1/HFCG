    ...
    <div id="wrapper" class="wrapper">
        <div class="scroller">
            <div class="w_titFrame">
                <p class="w_titImg"><img src="${ctx}/gameimg/anniversary/coupon_100.png" alt=""></p>
                <div class="w_tit">
                手机号<span class="w_phoneNum">${phone }</span>尚未注册，您可以长按下方的二维码关注财富派微信号并完成注册。注册成功后请重新进入活动页领取100元
                </div>
            </div>
