...
<script src="${ctx }/js/shareRegister.js" type="text/javascript"></script> 
<title>注册</title>
<style>
/*银行协议*/
.masks{
...
<body id="backgd" onload="b();">
	<!--/顶部错误提示栏开始/-->
	<span id="alart"></span>
    <!--/顶部错误提示栏结束/-->
     <img src="${ctx}/images/banner.png" style="width:100%; position:absolute; top:0; left:0;"/>
	<form  id="frm" action="${ctx}/game/regist/shareRegister" method="post" style="margin:30% 0 0 0;">
...
<c:if test="${not empty invite_code}">
	<input type="num" id="yqm" name="inviteCode" value="${invite_code}" style="color:#4b4b4b;" maxlength="6"  readonly="readonly"/>
