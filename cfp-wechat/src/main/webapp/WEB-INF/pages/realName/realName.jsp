...
<script data-main="${ctx}/js/RealNameIdent.js?${version}" src="${ctx}/js/lib/require.js"></script>
...
<section class="real-theme">
    <div class="name-box">
        <span>姓<i>？</i>名</span>
        <input type="text" placeholder="请输入姓名" class="name-case" id="name-case">
    </div>
    <div class="id-box">
        <span>身份证</span>
        <input type="text" placeholder="请输入身份证" class="id-case" id="id-case">
    </div>
