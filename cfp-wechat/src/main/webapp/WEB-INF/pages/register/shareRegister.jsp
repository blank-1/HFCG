...
<body class="l_NewScroll">
  ...
  <form  id="frm" action="${ctx}/user/regist/register" method="post" >
    ...
    <div class="l_checkCode">
        ...
        <i class="l_del"></i>
        <button id="checkCodeB"    class="pjred">获取验证码</button>
    </div>
    <div class="l_pswBox">
    ...
    <div>
        <input class="l_userId  l_code" value="${invite_code}"  type="tel" id="code" placeholder="邀请码 (非必选)" maxlength="8" ><i class="l_del"></i>
        <input type="hidden" value="${invite_code}" name="inviteCode" id="in_code">
    </div>
    ...
    <button class="l_load pjBred" title="indexNew.html" id="load">注册</button>
