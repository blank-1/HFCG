	...
	$.ajax({
		...
		success: function (data) { 
			...
			if(_data.isSuccess){
				...
				//alert(timestamp+"==="+nonceStr+"==="+signature);s
				wx.config({
				      debug: false,
...
wx.ready(function () {
	...
	wx.onMenuShareAppMessage({
	   title: '财富派一周年，约吗？',
	   desc: '宝宝一周岁，财富约起来！加息，绝对史无前例！',
	   link: 'http://m.caifupad.com/gamejs/fuli/wuliCaifupad.html',
	   imgUrl: 'http://m.caifupad.com/gamejs/fuli/images/fuli_share.jpg',
