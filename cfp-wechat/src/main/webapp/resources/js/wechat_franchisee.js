...
//2.1 监听“分享给朋友”，按钮点击、自定义分享内容及分享结果接口
 wx.onMenuShareAppMessage({
   title: '最强合伙人时代拉开帷幕!',
   desc: '蚂蚁投资特色金融分析交流会，于2015年12月19日-20日举办',
   link: 'http://m.caifupad.com/game/toAllianceWares',
   imgUrl: 'http://m.caifupad.com/gameimg/franchisee.jpg',
   ...
   success: function (res) {
     //alert('已分享');
     //window.location.href=rootPath+"/game/receive";
   },
   cancel: function (res) {
     //alert('已取消');
   },
