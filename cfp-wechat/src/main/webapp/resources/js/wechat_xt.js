...
//2.1 监听“分享给朋友”，按钮点击、自定义分享内容及分享结果接口
 wx.onMenuShareAppMessage({
   title: '鬼子进村了，我手撕了'+$("#resultNum").html()+'个鬼子！',
   desc: '重要事情说三遍，撕完还有10元拿',
   link: 'http://m.caifupad.com/game/index',
   imgUrl: 'http://m.caifupad.com/images/ssgz.png',
   ...
   success: function (res) {
     //alert('已分享');
     window.location.href=rootPath+"/game/toValidate";
   },
   cancel: function (res) {
     //alert('已取消');
   },
