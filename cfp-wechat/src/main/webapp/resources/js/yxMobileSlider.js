(function($){
    $.fn.yxMobileSlider = function(settings){
        ...
        return this.each(function(){
            ...
            //初始化焦点容器及按钮
            _this.append('<div class="focus"><b></b><div></div></div>');
            var oFocusContainer = $(".focus");
            for (var i = 0; i < num; i++) {
                $("div", oFocusContainer).append("<span></span>");
            }

            oFocusContainer.children("b").html(oLi.eq(0).find("img").attr("alt"));//一开始获取的alt
            ...
            function doMove(){
                ...
                oFocusContainer.children("b").html(oLi.eq(iCurr).find("img").attr("alt"));//对应每个的alt
...
oFocusContainer.children("b").html(oLi.eq(iCurr).find("img").attr("alt"));//滑动获取alt
    ...
    $.fn.yxMobileSlider1 = function(settings){
       ...
       return this.each(function(){
           ...
           //初始化焦点容器及按钮
           _this.append('<div class="focus1"><b></b><div></div></div>');
           var oFocusContainer = $(".focus1");
           for (var i = 0; i < num; i++) {
               $("div", oFocusContainer).append("<span></span>");
           }
